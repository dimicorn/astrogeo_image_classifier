...
| uv_quality       | varchar(100) | Autogenerated comment about UV data (currently empty string)                                                     |
| comment          | varchar(100) | Autogenerated overall comment about fields (currently empty string)                                             |
...
| map_quality   | int | 0 - for noisy maps, 1 - for the rest                  |
| comment       | varchar(100) | Autogenerated comment if map is noisy, else empty string            |
